...
void plot_protonKEff_Data_MC() {
	...
	//TString fmc=Form("/dune/app/users/hyliao/WORK/analysis/protodune/proton/analysis/mcdata/sce/MC_PDSPProd4a_MC_1GeV_reco1_sce_datadriven_v1/xs_thinslice/mc_kecalo_nobmrw_old2.root");
	...
	//TString fdata=Form("../data_kecalo_old2.root");

	TString fmc=Form("/dune/app/users/hyliao/WORK/analysis/protodune/proton/analysis/mcdata/sce/MC_PDSPProd4a_MC_1GeV_reco1_sce_datadriven_v1/xs_thinslice/mc_kecalo_bmrw_withbeammomcut.root");
	TString fmc_bmrw=Form("/dune/app/users/hyliao/WORK/analysis/protodune/proton/analysis/mcdata/sce/MC_PDSPProd4a_MC_1GeV_reco1_sce_datadriven_v1/xs_thinslice/mc_kecalo_bmrw_withbeammomcut.root");
	TString fdata=Form("../data_kecalo_withbeammomcut.root");

	TString rep_data="KEff"; //h2d_trklen_KEcalo_RecoInel//h1d_KEcalo_RecoInel
	TString rep_mc="keff_reco_constEcalo";

	TString fout="./plot_KEend_KEff/";
	...
	//leg0->AddEntry(mc_rw,Form("MC - #chi^{2}/dof:%.2f/%d",chi2_rw,data->GetNbinsX()), "l");
	leg0->AddEntry(mc_rw,Form("MC - #chi^{2}/dof:%.2f/%d",chi2_rw,NDF), "l");
	leg0->Draw();
	...
	c1->Print(Form("%skeff_data_mc.eps",fout.Data()));	

...
void plot_protonKEend_Data_MC() {
	...
	TString rep_data="KEcalo"; //h2d_trklen_KEcalo_RecoInel//h1d_KEcalo_RecoInel
	TString rep_mc="kecalo_reco_constEcalo";
	...
	int NDF=0;
		...
		//if (data->GetBinContent(k)==0||mc->GetBinContent(k)==0) continue;
		if (data->GetBinContent(k)==0) continue;
	...
	c1->Print(Form("%skeend_data_mc.eps",fout.Data()));	

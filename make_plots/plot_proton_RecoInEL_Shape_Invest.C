...
void plot_proton_RecoInEL_Shape_Invest() {

	
	TString fmc1=Form("../data_kebkg_new.root");
	//TString fmc2=Form("../data_kebkg_new_flatinelcut.root");
	TString fmc2=Form("../data_kebkg_withintersection.root");

	TString fout="./plotKE_recoinel_shape_kecalo";
	...
	TString fig_out=Form("%s%s_recoinelcomp.eps",fout.Data(),rep_data.Data());
	...
	//read MC -----------------------------------------------------------------------//
	TFile *f_mc1 = TFile::Open(fmc1.Data());
	TH1D *h1=(TH1D*)f_mc1->Get("ke_reco_RecoInEl");
	
	TFile *f_mc2 = TFile::Open(fmc2.Data());
	TH1D *h2=(TH1D*)f_mc2->Get("ke_reco_RecoInEl");

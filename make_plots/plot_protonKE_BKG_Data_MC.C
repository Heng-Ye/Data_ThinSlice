...
void plot_protonKE_BKG_Data_MC(TString fdata, TString fmc_bmrw, TString fout, TString rep_data, float xmin, float xmax, float ymax) {
	...
	//TString fmc_bmrw=Form("/dune/app/users/hyliao/WORK/analysis/protodune/proton/analysis/mcdata/sce/MC_PDSPProd4a_MC_1GeV_reco1_sce_datadriven_v1/xs_thinslice/mc_kebkg_bmrw.root");
	//TString fdata=Form("../data_kebkg.root");

	//TString fmc=Form("/dune/app/users/hyliao/WORK/analysis/protodune/proton/analysis/mcdata/sce/MC_PDSPProd4a_MC_1GeV_reco1_sce_datadriven_v1/xs_thinslice/mc_kebkg_bmrw_beamxy.root");
	//TString fmc_bmrw=Form("/dune/app/users/hyliao/WORK/analysis/protodune/proton/analysis/mcdata/sce/MC_PDSPProd4a_MC_1GeV_reco1_sce_datadriven_v1/xs_thinslice/mc_kebkg_bmrw_beamxy.root");
	//TString fdata=Form("../data_kebkg_beamxy.root");

	//TString fmc=Form("/dune/app/users/hyliao/WORK/analysis/protodune/proton/analysis/mcdata/sce/MC_PDSPProd4a_MC_1GeV_reco1_sce_datadriven_v1/xs_thinslice/mc_kebbbkg_bmrw.root");
	//TString fmc_bmrw=Form("/dune/app/users/hyliao/WORK/analysis/protodune/proton/analysis/mcdata/sce/MC_PDSPProd4a_MC_1GeV_reco1_sce_datadriven_v1/xs_thinslice/mc_kebbbkg_bmrw.root");
	//TString fdata=Form("../data_kebbbkg.root");

	//TString fmc=Form("/dune/app/users/hyliao/WORK/analysis/protodune/proton/analysis/mcdata/sce/MC_PDSPProd4a_MC_1GeV_reco1_sce_datadriven_v1/xs_thinslice/mc_kebbbkg_bmrw_beamxy.root");
	//TString fmc_bmrw=Form("/dune/app/users/hyliao/WORK/analysis/protodune/proton/analysis/mcdata/sce/MC_PDSPProd4a_MC_1GeV_reco1_sce_datadriven_v1/xs_thinslice/mc_kebbbkg_bmrw_beamxy.root");
	//TString fdata=Form("../data_kebbbkg_beamxy.root");


	//TString fmc=Form("/dune/app/users/hyliao/WORK/analysis/protodune/proton/analysis/mcdata/sce/MC_PDSPProd4a_MC_1GeV_reco1_sce_datadriven_v1/xs_thinslice/mc_kebbbkg_bmrw_new.root");
	//TString fmc_bmrw=Form("/dune/app/users/hyliao/WORK/analysis/protodune/proton/analysis/mcdata/sce/MC_PDSPProd4a_MC_1GeV_reco1_sce_datadriven_v1/xs_thinslice/mc_kebbbkg_bmrw_new.root");
	//TString fdata=Form("../data_kebbbkg.root");

	//TString fmc_bmrw=Form("/dune/app/users/hyliao/WORK/analysis/protodune/proton/analysis/mcdata/sce/MC_PDSPProd4a_MC_1GeV_reco1_sce_datadriven_v1/xs_thinslice/mc_kecalobkg_bmrw_new.root");
	TString fmc=fmc_bmrw;
	//TString fdata=Form("../data_kebkg.root");

	//TString fout="./plotKE_BKG/";
	//TString fout="./plotKE_BKG_beamxy/";
	//TString fout="./plotKEbb_BKG_beamxy/";

	//TString fout="./plotKE_BKG_new/";
	...
	//TString fig_out=Form("%s%s_bmrw_recoInEl.eps",fout.Data(),rep_data.Data());
	TString fig_out=Form("%s%s_bmrw_recoEl.eps",fout.Data(),rep_data.Data());
	//TString fig_out=Form("%s%s_bmrw_recoEl_zoom.eps",fout.Data(),rep_data.Data());
	//TString fig_out=Form("%s%s_bmrw_Misidp.eps",fout.Data(),rep_data.Data());
	//TString fig_out=Form("%s%s_bmrw_All.eps",fout.Data(),rep_data.Data());
	...
	//float ymax=300; //el,end,intersection
	//float ymax=50; //el,end,intersection
	

	//float ymax=1200; //el,all,end
	//float ymax=100; //el,end,zoom
	//float ymax=300; //inel,end
	//float ymax=40; //midp,end

	//float ymax=60; //midp,ff
	//float ymax=600; //inel,ff
	//float ymax=600; //el,ff
	//float ymax=1200; //all,ff


	//float ymax=2200; //el,end
	//float ymax=4200; //el,end
	//float ymax=3200; //el,end	
	//float ymax=300; //inel,end(kebb)
	//float ymax=70; //inel,end(kebb)
	//float ymax=30; //misid:p, intersection

	//float ymax=500; //all, bb,end
	//float ymax=400; //el, bb,end
	//float ymax=400; //inel, bb,end
	//float ymax=40; //midp, bb,end


	//float ymax=400;
	//float ymax=300;
	//float ymax=50; //misidp,end
	//float ymax=30; //misidp,end
	//float ymax=120; //misidp,ff
	//float ymax=30;
	//float ymax=600; //end,inel
	//float ymax=800;
	...
	//TH1D *h_data_trklen_all=(TH1D*)f_data->Get("trklen_All");
	...
	TH1D *h_mc_trklen_all=(TH1D*)f_mc->Get("trklen_All");
	...
	int NDF=0;
		...
		if (h_data->GetBinContent(k)==0&&h_mc->GetBinContent(k)==0) continue; //skip zero counts
	...
	leg0->AddEntry(h_mc_rw,Form("MC - #chi^{2}/dof:%.2f/%d",chi2_rw,NDF-2), "l");
	leg0->Draw();
...
/*
	...
	c2->Divide(1,1);
	c2->cd(1);
	h_data_trklen_all->Draw("ep");
	h_mc_trklen_all->SetLineColor(2);
	h_mc_trklen_all->Scale((float)h_data_trklen_all->Integral()/(float)h_mc_trklen_all->Integral());
	h_mc_trklen_all->Draw("hist same");
*/

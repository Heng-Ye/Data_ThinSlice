...
void plotKERW() {
	...
	TString fdata="../data_kecalo.root";
	TString fmc="/dune/app/users/hyliao/WORK/analysis/protodune/proton/analysis/mcdata/sce/MC_PDSPProd4a_MC_1GeV_reco1_sce_datadriven_v1/xs_thinslice/mc_kerw_tunning.root";
	TString outpath="./plots_KERW/";

	TString rep="KEcalo_RecoEl";
	TString x_axis_label="Proton KE [MeV]";
	...
	TH1D* h1d=(TH1D*)f_data->Get(Form("h1d_%s",rep.Data()));
	int n_stop_data=h1d->Integral(); 
...
*/
	...
	//data mu, sigma
	double m1_data=3.93027e+02; //Data prod4 reco2
	double s1_data=5.18623e+01; //Data prod4 reco2
	...
	c_1->Divide(1,1);
	c_1->cd(1);
	TH2D* frame2dx=new TH2D("frame2dx"," ", 150, -200, 400, 800, 0, 800); //for z2, trklen
